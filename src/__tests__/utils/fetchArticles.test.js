...
describe('fetchArticles', () => {
  ...
  it('should fetch articles and update state', async () => {
    ...
    expect(mockDispatch).toHaveBeenCalledWith({ type: 'SET_ARTICLES', payload: articles });
  ...
  it('should handle fetch error', async () => {
    ...
    expect(mockDispatch).toHaveBeenCalledWith({ type: 'SET_LOADING', payload: true });
    expect(mockDispatch).toHaveBeenCalledWith({ type: 'SET_ERROR', payload: 'Network error' });
